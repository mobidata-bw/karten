import { GeoJSON, Feature, LineString, MultiLineString, Polygon, MultiPolygon, FeatureCollection, Point, MultiPoint, Position } from 'geojson';
...
declare class FeatureData {
    ...
    updateGeoJsonProperties(properties: ShapeGeoJsonProperties): void;
...
declare class Features {
    ...
    exportGeoJson(): GeoJsonShapeFeatureCollection;
...
declare const pointerEvents: readonly ["click", "dblclick", "mousedown", "mouseup", "mousemove", "mouseenter", "mouseleave", "mouseover", "mouseout", "contextmenu", "touchstart", "touchend", "touchcancel"];
...
type Draw = Omit<GMDrawShapeEvent, 'mode' | 'variant'> & {
    mode: 'line';
    variant: 'line_drawer';
};
...
type GMDrawEvent = GMDrawModeEvent | GMDrawShapeEvent | GMDrawShapeEventWithData | Draw | GMDrawLineDrawerEventWithData | GMDrawFreehandDrawerEvent | GMDrawFreehandDrawerEventWithData | GMDrawShapeCreatedEvent;
...
declare class Geoman {
    ...
    enableGlobalCopyMode(): void;
    disableGlobalCopyMode(): void;
    toggleGlobalCopyMode(): void;
    globalCopyModeEnabled(): boolean;
    enableGlobalCutMode(): void;
    disableGlobalCutMode(): void;
    toggleGlobalCutMode(): void;
    globalCutModeEnabled(): boolean;
    enableGlobalSplitMode(): void;
    disableGlobalSplitMode(): void;
    toggleGlobalSplitMode(): void;
    ...
    enableGlobalLassoMode(): void;
    disableGlobalLassoMode(): void;
    toggleGlobalLassoMode(): void;
