import{a as R,l as h,i as m,b as I,c as z,d as B}from"../../addControlLayers-C4CIdj9Z.js";import{p as D}from"../../popupImages-BVuzBbt9.js";import{p as L}from"../../popups-CWAOagCD.js";window.PUBLIC_PATH="/karten/";const k={layer:"MobiData-BW:bicycle_service_points",style:"",bounds:[7.3,47.4,10.4,49.7],server:"test"},a={source:"sourceBicycleServicePoints",sourceLayer:"bicycle_service_points",group:"Datengeber"},v=[{id:"TFIS",label:"Touristisches Freizeitinformationssystem",filter:["any",["==",["get","Datengeber"],"TFISReparatur"],["==",["get","Datengeber"],"TFISRadservicepunkte"]],color:"#cacaca",...a},{id:"radvis",label:"RadVIS",filter:["==",["get","Datengeber"],"RadVIS"],color:"#e6007d",...a},{id:"radkultur",label:"RadKULTUR",filter:["==",["get","Datengeber"],"RadKULTUR"],color:"#0d46a0ff",...a},{id:"konstanz",label:"Stadt Konstanz",filter:["==",["get","Datengeber"],"SB_Fahrradreparaturstationen(Konstanz)"],color:"#00ff00",...a},{id:"freiburg",label:"Stadt Freiburg im Breisgau",filter:["==",["get","Datengeber"],"Frelo-Radreparaturstationen"],color:"black",...a},{id:"adac",label:"ADAC",filter:["==",["get","Datengeber"],"ADAC"],color:"#ffd000",...a}];function F(t){const{RadVIS_ID:r,Name:e,Betreiber:n,Zuestaendig_in_RadVIS:d,Servicestation_Typ:o,Marke:l,Luftpumpe:i,Kettenwerkzeug:c,Werkzeug:u,Fahrradhalterung:g,Gebuehren:b,Oeffnungszeiten:p,Beschreibung:f,QuelleLayer:$}=t,y={RadVIS:"RadVIS",RadKULTUR:"RadKULTUR","SB_Fahrradreparaturstationen(Konstanz)":"Stadt Konstanz","Frelo-Radreparaturstationen":"Stadt Freiburg im Breisgau"};let S="";for(let C in y)$==C&&!$.includes("TFIS")&&(S+=D(y[C]));return`
        <table>
            <tr>
                ${S}
