import{s as c,j as l,a as d,l as i,i as b,b as p,c as m,d as u}from"../../addControlLayers-BMAPoybg.js";import{p as h}from"../../popups-RroL-G3M.js";window.PUBLIC_PATH="/karten/";const w=c("maps/ipl/webcam","webcam"),C=[{id:"webcam",group:"Webcam-Bilder",label:"Standorte",source:"sourceWebcam",color:"white"}];function f(t){const{strasse:e,bezeichnung:a,blickrichtung:o,kamera_nr:r,bild:n}=t;return`
        <table>
            <tr>              
                <th class='title'>${r}</th>
            </tr>
