import{s as c,j as l,a as d,l as i,i as b,b as p,c as m,d as u}from"../../addControlLayers-D3tR2xcO.js";import{p as h}from"../../popups-CuX-XJdL.js";window.PUBLIC_PATH="/karten/";const C=c({format:"geojson",directory:"maps/ipl/webcam",file:"webcam"}),f=[{id:"webcam",group:"Webcam-Bilder",label:"Standorte",source:"sourceWebcam",color:"grey"}];function g(t){const{strasse:e,bezeichnung:a,blickrichtung:o,kamera_nr:r,bild:n}=t;return`
        <table>
            <tr>              
                <th class='title'>${r}</th>
            </tr>
