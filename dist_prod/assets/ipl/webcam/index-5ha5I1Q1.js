import{s as c,j as l,a as d,l as i,i as b,b as m,c as p,d as u}from"../../addControlLayers-BmUhqY7m.js";import{p as h}from"../../popups-aQvfhhdH.js";window.PUBLIC_PATH="/karten/";const C=c("maps/ipl/webcam","webcam"),w=[{id:"webcam",group:"Webcam-Bilder",label:"Webcam-Standorte",source:"sourceWebcam",color:"black"}];function g(t){const{strasse:e,bezeichnung:a,blickrichtung:o,kamera_nr:r,bild:n}=t;return`
        <table>
            <tr>              
                <th class='title'>${e}</th>
            </tr>
