import{s as i,a as c,l as u,i as C,b as p,c as m,d as y}from"../addControlLayers-BdCcY69e.js";import{s as L}from"../setupLayerInteractions-BnLOBWbE.js";window.PUBLIC_PATH="/karten/";const $=i({format:"mbtiles",file:"inrix",promoteId:"XDSegID"}),f=[{id:"inrix",group:"INRIX",type:"line",label:"Straßenabschnitte",source:"sourceInrix",sourceLayer:"inrix",color:"red",lineWidth:["interpolate",["linear"],["zoom"],6,1,12,4]}];function I(t){const{XDSegID:e,FRC:a,County:r,PostalCode:n,Miles:o,Lanes:d,RoadList:l}=t;return`
        <table>            
           ${e==""?"":`
            <tr>
