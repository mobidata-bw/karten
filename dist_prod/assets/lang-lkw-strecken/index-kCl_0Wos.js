import{s as l,a as c,l as d,i,b as u,c as p,d as C}from"../addControlLayers-CK2s8XcE.js";import{s as k}from"../setupLayerInteractions-Dp18YMFs.js";window.PUBLIC_PATH="/karten/";const g=l({format:"geojson",directory:"maps/lang-lkw-strecken",file:"lang-lkw-strecken",promoteId:"ID"}),y=[{id:"lang-lkw-strecken",label:"Strecken",group:"Lang-LKW-Strecken",type:"line",source:"sourceTruckRoutes",color:"#C4001F",lineWidth:["interpolate",["linear"],["zoom"],6,1,12,4]}];function f(t){const{ID:a,TYP:e,STR_KENNUNG:o,BESCHREIBUNG:n,FAHRTRICHTUNG:r}=t;return`
        <table>          
            <tr>
                <td class="att">ID</td>                
