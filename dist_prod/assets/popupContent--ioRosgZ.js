import{s as o}from"./addControlLayers-oFVf9ecf.js";import{p as f}from"./popupImages-ClJBt1BX.js";const w={type:"geojson",data:{type:"FeatureCollection",features:[]}},k={type:"geojson",data:{type:"FeatureCollection",features:[]}},m={type:"geojson",data:{type:"FeatureCollection",features:[]}},F=o("maps/pedestrian_crossings","zebra"),n={group:"Fußgängerüberwege"},v=[{id:"uncontrolled",label:"Uncontrolled",source:"sourceUncontrolled",color:"#C4001F",...n,url:o("maps/pedestrian_crossings","uncontrolled").data,visibility:"none"},{id:"footway",label:"Footway",source:"sourceFootway",color:"#75b9a2",...n,url:o("maps/pedestrian_crossings","footway").data,visibility:"none"},{id:"marked",label:"Marked",source:"sourceMarked",color:"#ffe280",...n,url:o("maps/pedestrian_crossings","marked").data,visibility:"none"},{id:"zebra",label:"Zebra",source:"sourceZebra",color:"#366491",...n}];function S(h){const{id:u,id_2:b,check_date:d,check_da_1:r,check_da_2:l,check_da_3:c,check_da_4:i,check_da_5:$,survey_dat:p,highway:e,turning_circle:g,kerb:a,surface:t,wheelchair:s,image:C}=h;return`
        <table>
            <tr>
                ${f("OpenStreetMap")}
