import{s as r,a as c,l as g,e as s,i as p,b,c as v,d as f}from"../../addControlLayers-MMhni-RC.js";import{p as k}from"../../popups-CyquQWAi.js";window.PUBLIC_PATH="/karten/";const y=r("maps/auswertungen/oepnv_gueteklassen","regierungsbezirke"),h={id:"lineShapeRegierungsbezirke",type:"line",source:"shapeRegierungsbezirke",paint:{"line-color":"black","line-width":1},layout:{visibility:"visible"}},G=r("maps/auswertungen/oepnv_gueteklassen","oepnv_gueteklassen_stuttgart"),C={type:"geojson",data:{type:"FeatureCollection",features:[]}},w={type:"geojson",data:{type:"FeatureCollection",features:[]}},m={type:"geojson",data:{type:"FeatureCollection",features:[]}},i={group:"ÖPNV-Güteklassen",subGroup:"Regierungsbezirke",exclusiveWithinGroup:!0,type:"fill",fillSortKey:["index-of",["get","qg"],["literal",["J","I","H","G","F","E","D","C","B","A"]]],color:["match",["get","qg"],"A","#ab1417","B","#e75739","C","#fdae61","D","#fed266","E","#efef63","F","#aedc5e","G","#5fba4f","H","#5c9c7e","I","#5a84e5","J","#4b44f3","#cacaca"],fillOpacity:.9,fillOutlineColor:"transparent"},_=[{id:"oepnvGueteklassenTuebingen",label:"Tübingen",source:"sourceOepnvGueteklassenTuebingen",visibility:"none",legendColor:"none",...i,url:r("maps/auswertungen/oepnv_gueteklassen","oepnv_gueteklassen_tuebingen").data},{id:"oepnvGueteklassenFreiburg",label:"Freiburg",source:"sourceOepnvGueteklassenFreiburg",visibility:"none",legendColor:"none",...i,url:r("maps/auswertungen/oepnv_gueteklassen","oepnv_gueteklassen_freiburg").data},{id:"oepnvGueteklassenKarlsruhe",label:"Karlsruhe",source:"sourceOepnvGueteklassenKarlsruhe",visibility:"none",legendColor:"none",...i,url:r("maps/auswertungen/oepnv_gueteklassen","oepnv_gueteklassen_karlsruhe").data},{id:"oepnvGueteklassenStuttgart",label:"Stuttgart",source:"sourceOepnvGueteklassenStuttgart",legendColor:"none",...i}];function O(e){const{qg:n,su:a,sc:t,pt:l}=e;return`
        <table>
            <tr>
