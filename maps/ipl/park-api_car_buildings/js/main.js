...
window.addEventListener('DOMContentLoaded', async () => {
    ...
    const [
        ...
        { sourceParkApiCarBuildings, layersParkApiCarBuildingsOccupancy, layersParkApiCarBuildingsObjects, layersParkApiCarBuildingsTypes, layersParkApiCarBuildingsSpecialParking },
