import{s as c,j as l,a as d,l as i,i as b,b as m,c as p,d as u}from"../../addControlLayers-4SG0jrLq.js";import{s as h}from"../../setupLayerInteractions-DoshFRq6.js";window.PUBLIC_PATH="/karten_test/";const C=c({format:"geojson",directory:"maps/ipl/webcam",file:"webcam"}),f=[{id:"webcam",group:"Webcam-Bilder",label:"Standorte",source:"sourceWebcam",color:"grey"}];function g(t){const{strasse:e,bezeichnung:a,blickrichtung:r,kamera_nr:o,bild:n}=t;return`
        <table>
            <tr>              
                <th class='title'>${o}</th>
            </tr>
