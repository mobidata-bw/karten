import{s as g,a as f,l as C,i as k,b as z,c as $,d as L}from"../../addControlLayers-x8KAuAWX.js";import{p as P}from"../../popupImages-Cu5BjjPJ.js";import{p as j}from"../../popups-BWlddmCE.js";window.PUBLIC_PATH="/karten_test/";const y=g("pmtiles","maps/auswertungen/transparenzportale","transparenzportale"),r={source:"sourceTransparenzportale",sourceLayer:"transparenzportale",group:"Transparenzportale",type:"fill"},B=[{id:"transparenzportale_Land",label:"Nationale Portale",filter:["==",["get","region"],"Land"],color:"#7dc4204d",...r},{id:"transparenzportale_Bundesland",label:"MobiData BW®",filter:["==",["get","region"],"Bundesland"],color:"#0c79bc",...r},{id:"transparenzportale_Verkehrsverbund",label:"Verbundsportale",filter:["==",["get","region"],"Verkehrsverbund"],color:"#d7a4a4",...r},{id:"transparenzportale_Kommune",label:"Kommunale Portale",filter:["==",["get","region"],"Kommune"],color:"#ffc300",...r}];function v(t){const{name:e,portal:a,ÖPNV:o,Sharing:s,Parken:l,Radverkehr:d,Laden:i,Barrierefreiheit:c,Baustellen:p,Verkehrszeichen:u,Verkehrskameras:h,Autoverkehr:b,url:m}=t;return`
    ...
    `}function V(t){const e={collapsed:!1,layers:f(n,"Legende")},a=new C(e);t.addControl(a,"top-right")}let n;window.addEventListener("DOMContentLoaded",()=>{const t=k();z(t),t.on("load",()=>{[{id:"sourceTransparenzportale",source:y}].forEach(a=>$(t,a)),n=B,n.forEach(a=>L(t,a)),V(t),j(t,n,v)})});
