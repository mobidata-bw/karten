import{s as a,a as u,l as i,i as c,b as d,c as g,d as p}from"../../addControlLayers-DkKEqnNS.js";import{p as b}from"../../popups-BDlfsaYT.js";window.PUBLIC_PATH="/karten_test/";const k=a("maps/auswertungen/oepnv_gueteklassen","regierungsbezirke"),v={id:"lineShapeRegierungsbezirke",type:"line",source:"shapeRegierungsbezirke",paint:{"line-color":"black","line-width":1},layout:{visibility:"visible"}},G=a("maps/auswertungen/oepnv_gueteklassen","oepnv_gueteklassen_stuttgart"),h={type:"geojson",data:{type:"FeatureCollection",features:[]}},f={type:"geojson",data:{type:"FeatureCollection",features:[]}},y={type:"geojson",data:{type:"FeatureCollection",features:[]}},r={group:"ÖPNV-Güteklassen",subGroup:"Regierungsbezirke",exclusiveWithinGroup:!0,type:"fill",fillSortKey:["index-of",["get","qg"],["literal",["J","I","H","G","F","E","D","C","B","A"]]],color:["match",["get","qg"],"A","#ab1417","B","#e75739","C","#fdae61","D","#fed266","E","#efef63","F","#aedc5e","G","#5fba4f","H","#5c9c7e","I","#5a84e5","J","#4b44f3","#cacaca"],fillOpacity:.05,fillOutlineColor:"transparent"},C=[{id:"oepnvGueteklassenTuebingen",label:"Tübingen",source:"sourceOepnvGueteklassenTuebingen",visibility:"none",legendColor:"none",...r,url:a("maps/auswertungen/oepnv_gueteklassen","oepnv_gueteklassen_tuebingen").data},{id:"oepnvGueteklassenFreiburg",label:"Freiburg",source:"sourceOepnvGueteklassenFreiburg",visibility:"none",legendColor:"none",...r,url:a("maps/auswertungen/oepnv_gueteklassen","oepnv_gueteklassen_freiburg").data},{id:"oepnvGueteklassenKarlsruhe",label:"Karlsruhe",source:"sourceOepnvGueteklassenKarlsruhe",visibility:"none",legendColor:"none",...r,url:a("maps/auswertungen/oepnv_gueteklassen","oepnv_gueteklassen_karlsruhe").data},{id:"oepnvGueteklassenStuttgart",label:"Stuttgart",source:"sourceOepnvGueteklassenStuttgart",legendColor:"none",...r}];function m(e){const{qg:n,su:s,sc:l,pt:t}=e;return`
        <table>
            <tr>
