import{s as c,a as l,l as d,i as u,b as i,c as p,d as C}from"../addControlLayers-Dtjlugl7.js";import{p as k}from"../popups-g8VnNlv9.js";window.PUBLIC_PATH="/karten_test/";const g=c({format:"geojson",directory:"maps/lang-lkw-strecken",file:"lang-lkw-strecken"}),y=[{id:"lang-lkw-strecken",label:"Strecken",group:"Lang-LKW-Strecken",type:"line",source:"sourceTruckRoutes",color:"#C4001F"}];function f(t){const{ID:s,TYP:e,STR_KENNUNG:o,BESCHREIBUNG:r,FAHRTRICHTUNG:n}=t;return`
        <table>          
            <tr>
                <td class="att">ID</td>                
