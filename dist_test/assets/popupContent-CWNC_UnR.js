    ...
    `,J=`
        ...
        <table>
            ...
            <tr>
                ...
                ${n&&D!=55?`<td class="attContent outDated">${h}, ${P}</td>`:`<td class="attContent">${h}, ${P}</td>`}
            </tr>
            `}
        </table>
        <br>
        ...
        <table id="divURLs">
            <tr>
                ...
                <td class="attContentLink"><a href="https://${Z}.mobidata-bw.de/park-api/api/public/v3/parking-${e}s/${r}" target="_blank">&#10149 ParkAPI</a></td>
                ${u?`<td class="attContentLink"><a href="${u}" class="photoMargin" target="_blank">&#10149 Foto</a></td>`:""}
            </tr>
        </table>
    `;return setTimeout(()=>{let K="",W="";dt.then(tt=>{tt.forEach(X=>{const w={aalen:"Stadt Aalen",apcoa:"APCOA PARKING",bahn_v2:"DB BahnPark",bb_parkhaus:"B+B Parkhaus GmbH & Co. KG",bfrk:"NVBW",bietigheim_bissingen:"Stadt Bietigheim-Bissingen",buchen:"Stadt Buchen",ellwangen:"Stadt Ellwangen",esslingen:"Stadt Esslingen",freiburg:"Stadt Freiburg im Breisgau",friedrichshafen:"Stadt Friedrichshafen",goldbeck:"Goldbeck",heidelberg:"Stadt Heidelberg",herrenberg:"Stadt Herrenberg",huefner:"PARK SERVICE HÜFNER GmbH + Co. KG",karlsruhe:"Stadt Karlsruhe",keltern:"Stadt Keltern",kienzler:"Kienzler",konstanz:"Stadt Konstanz",ladenburg:"Stadt Ladenburg",mannheim:"Stadt Mannheim",m_bw:"Ministerium für Verkehr Baden-Württemberg",neckarsulm:"Stadt Neckarsulm",opendata_swiss:"Open-Data-Plattform Schweiz",pbw:"Parkraumgesellschaft Baden-Württemberg mbH",pforzheim:"Stadt Pforzheim",p_m_sensade:"Ministerium für Verkehr Baden-Württemberg",radvis_bw:"RadVIS",radolfzell:"Stadt Radolfzell",reutlingen:"Stadt Reutlingen",stuttgart_:"Stadt Stuttgart",ulm_:"Stadt Ulm",velobrix:"Velobrix",vrn_:"Verkehrsverbund Rhein-Neckar",vrs:"Verband Region Stuttgart"};for(let F in w)X.uid.match(F)&&D==X.id&&(K+=at(w[F]),W+=`<td class="attContent">${w[F]}</td>`)});const V=document.getElementById("logos-"+r);V&&K&&(V.innerHTML=K);const Y=document.getElementById("datengeber-"+r);Y&&W&&(Y.innerHTML=`
