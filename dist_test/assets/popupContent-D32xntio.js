import{s as c}from"./addControlLayers-liukC-jJ.js";const g=c("maps/count_car","SVZ-Zaehlstellen_231011_augmented_SVZ2023"),t={source:"sourceCountCar",group:"Straßenverkehrszählung"},h=[{id:"countCarTemporary",label:"Temporäre Zählstellen",filter:["case",["<",["zoom"],10],["all",["==",["get","zstart"],"TM"],["==",["get","klasse"],"A"]],["==",["get","zstart"],"TM"]],color:"#7D97DD",...t},{id:"countCarPermanent",label:"Dauerzählstellen",filter:["case",["<",["zoom"],10],["all",["==",["get","zstart"],"DZ"],["==",["get","klasse"],"A"]],["==",["get","zstart"],"DZ"]],color:"#FF5050",...t},{id:"countCarManual",label:"Manuelle Zählstellen",filter:["case",["<",["zoom"],10],["all",["==",["get","zstart"],"MZ"],["==",["get","klasse"],"A"]],["==",["get","zstart"],"MZ"]],color:"#fffb05",...t}];function i(n){const{klasse:u,nummer:o,svznr:e,RI:a,RII:s,DTV2023:r,DTVSV:l,zstart:d}=n;return`
        <table>            <tr>
                <th class="title">${o}</th>
            </tr>
        </table><br><table>
