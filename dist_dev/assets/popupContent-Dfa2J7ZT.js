import{s as o}from"./setFilePath-CKvzmloB.js";import{p as f}from"./popupImages-BqgrDCos.js";const w=o("pmtiles","maps/pedestrian_crossings","footway"),k=o("pmtiles","maps/pedestrian_crossings","marked"),y=o("pmtiles","maps/pedestrian_crossings","uncontrolled"),F=o("pmtiles","maps/pedestrian_crossings","zebra"),n={group:"Fußgängerüberwege"},z=[{id:"uncontrolled",label:"Uncontrolled",source:"sourceUncontrolled",sourceLayer:"uncontrolled",color:"#C4001F",...n},{id:"footway",label:"Footway",source:"sourceFootway",sourceLayer:"footway",color:"#75b9a2",...n},{id:"marked",label:"Marked",source:"sourceMarked",sourceLayer:"marked",color:"#ffe280",...n},{id:"zebra",label:"Zebra",source:"sourceZebra",sourceLayer:"zebra",color:"#366491",...n}];function S(C){const{id:u,id_2:b,check_date:r,check_da_1:d,check_da_2:c,check_da_3:l,check_da_4:i,check_da_5:$,survey_dat:p,highway:e,turning_circle:h,kerb:a,surface:t,wheelchair:s,image:g}=C;return`
        <table>
            <tr>
                ${f("OpenStreetMap")}
