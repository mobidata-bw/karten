import{s as f,a as g,l as b,i as x,b as X,c as N,d as P}from"../addControlLayers-BbjHMMCy.js";import{p as h}from"../popups-RbKY9FbN.js";window.PUBLIC_PATH="/karten_dev/";const w=f({format:"mbtiles",file:"inrix"}),v={group:"INRIX",type:"line",lineWidth:["interpolate",["linear"],["zoom"],6,1,12,2]},F=[{id:"inrix",label:"Straßenabschnitte",source:"sourceInrix",sourceLayer:"inrix",color:"#C4001F",...v}];function M(t){const{OID:s,XDSegID:a,PreviousXD:r,NextXDSegI:e,FRC:o,RoadNumber:n,RoadName:l,LinearID:c,Country:i,State:$,County:C,District:u,PostalCode:p,Miles:D,Lanes:y,SlipRoad:I,SpecialRoa:L,RoadList:m,Bearing:R,XDGroup:S}=t;return`
        <table>
            ${s==""?"":`
            <tr>
                <td class="att">OID</td>
    ...
    `}function z(t){const s={collapsed:!1,layers:g(d,"Legende")},a=new b(s);t.addControl(a,"top-right")}let d;window.addEventListener("DOMContentLoaded",()=>{const t=x();X(t),t.on("load",()=>{[{id:"sourceInrix",source:w}].forEach(a=>N(t,a)),d=F,d.forEach(a=>P(t,a)),z(t),h(t,d,M)})});
