import{a as K,l as T,i as k,b as N,c as y,d as M}from"../../addControlLayers-DpI8AOJ_.js";import{s as V}from"../../setFilePath-CKvzmloB.js";import{p as w}from"../../popupImages-BqgrDCos.js";import{p as z}from"../../popups-D19OfOkG.js";window.PUBLIC_PATH="/karten_dev/";const P=V("geojson","maps/map-as-a-service/strassenverkehrszaehlung_ravensburg","strassenverkehrszaehlung_ravensburg"),c={source:"sourceCountRavensburg",group:"Straßenverkehrszählung Ravensburg"},a=["case",["!=",["get","KFZ_1"],null],["+",["get","KFZ_1"],["get","RAD_1"],["get","FUSSGAENGER_1"],["get","SV_1"]],["!=",["get","KFZ_2"],null],["+",["get","KFZ_2"],["get","RAD_2"],["get","FUSSGAENGER_2"],["get","SV_2"]],["!=",["get","KFZ_3"],null],["+",["get","KFZ_3"],["get","RAD_3"],["get","FUSSGAENGER_3"],["get","SV_3"]],["!=",["get","KFZ_4"],null],["+",["get","KFZ_4"],["get","RAD_4"],["get","FUSSGAENGER_4"],["get","SV_4"]],0],I=[{id:"countRavensburg1",label:"bis 1 Tsd.",filter:["<=",a,1e3],color:"#ffe600",...c},{id:"countRavensburg2",label:"1 - 5 Tsd.",filter:["all",[">",a,1e3],["<=",a,5e3]],color:"#f6b500",...c},{id:"countRavensburg3",label:"5 Tsd. - 15 Tsd.",filter:["all",[">",a,5e3],["<=",a,15e3]],color:"#e78300",...c},{id:"countRavensburg4",label:"15 Tsd. - 30 Tsd.",filter:["all",[">",a,15e3],["<=",a,3e4]],color:"#d25000",...c},{id:"countRavensburg5",label:"über 30 Tsd.",filter:[">",a,3e4],color:"#b70101",...c}];function j(t){const{ID:r,NAME:e,KFZ_1:b,RAD_1:f,FUSSGAENGER_1:R,SV_1:p,DATUM_1:F,KFZ_2:A,RAD_2:v,FUSSGAENGER_2:h,SV_2:C,DATUM_2:S,KFZ_3:E,RAD_3:G,FUSSGAENGER_3:$,SV_3:m,DATUM_3:u,KFZ_4:D,RAD_4:Z,FUSSGAENGER_4:L,SV_4:U,DATUM_4:g}=t;let n,o,l,d,s;!S&&!u&&!g?(n=b,o=f,l=R,d=p,s=F):!u&&!g?(n=A,o=v,l=h,d=C,s=S):g?(n=D,o=Z,l=L,d=U,s=g):(n=E,o=G,l=$,d=m,s=u);let _;return _="/karten_geojsons/maps/map-as-a-service/strassenverkehrszaehlung_ravensburg",`
    ...
    `}function x(t){const r={collapsed:!1,layers:K(i,"Legende")},e=new T(r);t.addControl(e,"top-right")}let i;window.addEventListener("DOMContentLoaded",()=>{const t=k({configZoom:window.innerWidth<577?10:12,configCenter:[9.609503,47.780424],configMinZoom:10,configShape:"shapeRavensburg"});N(t),t.on("load",()=>{[{id:"sourceCountRavensburg",source:P}].forEach(e=>y(t,e)),i=I,i.forEach(e=>M(t,e)),x(t),z(t,i,j)})});
