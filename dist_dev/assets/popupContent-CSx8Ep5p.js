import{u as T,t as et}from"./timeStamps-DV8Kc6Rw.js";import{k as Z}from"./addControlLayers-DdHOxOpH.js";import{p as at}from"./popupImages-CL540eOO.js";const{purpose:h,type:D,parking:I,geometry:R,object:z,layerFilter:it,layerGroup:st,id:E}=T(),pt={layer:"MobiData-BW:park-api_car",style:"MobiData-BW:mdbw_park-api_parking-object",bounds:[5.9,45.8,17,54.8]},bt={layer:"MobiData-BW:park-api_car_lines",style:"MobiData-BW:mdbw_lines",bounds:[7,46,10,50]},gt={layer:"MobiData-BW:park-api_car_polygons",style:"MobiData-BW:mdbw_polygons",bounds:[7,46,10,50]},ut={layer:"MobiData-BW:park-api_bicycle",style:"MobiData-BW:mdbw_park-api_parking-object",bounds:[7.1,47.5,13.5,53.8]};function M({id:t,layerGroup:e,layerFilter:a}){return[{id:`parkApi${t}Occupancy_NoRealtimeInformation`,label:"Echtzeitdaten nicht vorhanden",subGroup:"Belegung",filter:["any",["all",["==",["get","parking_object"],"site"],["==",["get","has_realtime_data"],!1],a],["all",["==",["get","parking_object"],"spot"],["any",["==",["get","realtime_status"],"UNKNOWN"],["==",["get","has_realtime_data"],!1]],a]],color:"#615fdf",scope:["car","bicycle","item","buildings","on_street","disabled","site","spot"],...e},{id:`parkApi${t}Occupancy_OutdatedRealtimeInformation`,label:"Echtzeitdaten älter 30 Minuten",subGroup:"Belegung",filter:["all",["==",["get","has_realtime_data"],!0],["==",["get","realtime_data_outdated"],!0],a,["!=",["get","source_id"],55]],color:"#cacaca",scope:["car","bicycle","item","buildings","disabled"],...e},{id:`parkApi${t}Occupancy_Closed`,label:"Geschlossen",subGroup:"Belegung",filter:["all",["==",["get","realtime_opening_status"],"CLOSED"],a],color:"#880000",scope:["car","bicycle","item","buildings","disabled","site"],...e},{id:`parkApi${t}Occupancy_VeryLowAvailability`,label:"Kaum Plätze (unter 2 %)",subGroup:"Belegung",filter:["any",["all",["==",["get","parking_object"],"site"],["==",["get","has_realtime_data"],!0],["all",[">=",["get","realtime_free_capacity"],0],["<",["/",["*",1,["get","realtime_free_capacity"]],["case",["has","realtime_capacity"],["get","realtime_capacity"],["get","capacity"]]],.02],["!=",["get","realtime_opening_status"],"CLOSED"]],["any",["==",["get","realtime_data_outdated"],!1],["==",["get","source_id"],55]],a],["all",["==",["get","parking_object"],"spot"],["==",["get","realtime_status"],"TAKEN"],["==",["get","has_realtime_data"],!0],["any",["==",["get","realtime_data_outdated"],!1],["==",["get","source_id"],55]],a]],color:"#ed0000",scope:["car","bicycle","item","buildings","on_street","disabled","site","spot"],...e},{id:`parkApi${t}Occupancy_LowAvailability`,label:"Wenig Plätze (2 bis 20 %)",subGroup:"Belegung",filter:["all",["==",["get","parking_object"],"site"],["==",["get","has_realtime_data"],!0],["all",[">=",["/",["*",1,["get","realtime_free_capacity"]],["case",["has","realtime_capacity"],["get","realtime_capacity"],["get","capacity"]]],.02],["<=",["/",["*",1,["get","realtime_free_capacity"]],["case",["has","realtime_capacity"],["get","realtime_capacity"],["get","capacity"]]],.2]],["!=",["get","realtime_opening_status"],"CLOSED"],["any",["==",["get","realtime_data_outdated"],!1],["==",["get","source_id"],55]],a],color:"#dfab27",scope:["car","bicycle","item","buildings","disabled","site"],...e},{id:`parkApi${t}Occupancy_HighAvailability`,label:"Viele Plätze (über 20 %)",subGroup:"Belegung",filter:["any",["all",["==",["get","parking_object"],"site"],["==",["get","has_realtime_data"],!0],[">",["/",["*",1,["get","realtime_free_capacity"]],["case",["has","realtime_capacity"],["get","realtime_capacity"],["get","capacity"]]],.2],["!=",["get","realtime_opening_status"],"CLOSED"],["any",["==",["get","realtime_data_outdated"],!1],["==",["get","source_id"],55]],a],["all",["==",["get","parking_object"],"spot"],["==",["get","realtime_status"],"AVAILABLE"],["==",["get","has_realtime_data"],!0],["any",["==",["get","realtime_data_outdated"],!1],["==",["get","source_id"],55]],a]],color:"#059b02",scope:["car","bicycle","item","buildings","on_street","disabled","site","spot"],...e}]}const j=M(T());let H;h=="car"?D==null&&I==null&&R==null&&z==null?H=j.filter(t=>t.scope.includes(h)):H=j.filter(t=>t.scope.includes(h)&&(t.scope.includes(D)||t.scope.includes(I)||t.scope.includes(R)||t.scope.includes(z))):H=j;const _t=M(T({purpose:"car"})).filter(t=>t.scope.includes("car")),yt=M(T({purpose:"bicycle"})).filter(t=>t.scope.includes("bicycle")),mt=M(T({purpose:"item"})).filter(t=>t.scope.includes("item"));function q({id:t,layerGroup:e,layerFilter:a}){return[{id:`parkApi${t}Type_Other`,label:"Sonstige",subGroup:"Typ",filter:["all",["any",["==",["get","type"],"OTHER"],["!",["has","type"]]],a],color:"#cacaca",visibility:"none",scope:["car","bicycle","buildings","on_street","disabled","polygon","site","spot"],...e},{id:"parkApiCarType_OnStreet",label:"Straßen-Parkplatz",subGroup:"Typ",filter:["all",["==",["get","type"],"ON_STREET"],a],color:"black",scope:["car","on_street","disabled","line","polygon","site","spot"],visibility:"none",...e},{id:"parkApiCarType_OffStreet",label:"Parkplatz abseits der Straße",subGroup:"Typ",filter:["all",["==",["get","type"],"OFF_STREET_PARKING_GROUND"],a],color:"#009688",visibility:"none",scope:["car","buildings","disabled","polygon","site","spot"],...e},{id:"parkApiCarType_Underground",label:"Tiefgarage",subGroup:"Typ",filter:["all",["==",["get","type"],"UNDERGROUND"],a],color:"#BF91B6",visibility:"none",scope:["car","buildings","disabled","site"],...e},{id:"parkApiCarType_CarPark",label:"Parkhaus",subGroup:"Typ",filter:["all",["==",["get","type"],"CAR_PARK"],a],color:"#5587eb",visibility:"none",scope:["car","buildings","disabled","polygon","site"],...e},{id:"parkApiBicycleType_WallLoops",label:"Vorderradhalter",subGroup:"Typ",filter:["==",["get","type"],"WALL_LOOPS"],color:"#5587eb",visibility:"none",scope:["bicycle"],...e},{id:"parkApiBicycleType_Stands",label:"Anlehnbügel",subGroup:"Typ",filter:["==",["get","type"],"STANDS"],color:"#bf91b6",visibility:"none",scope:["bicycle"],...e},{id:"parkApiBicycleType_LockersLockbox",label:"Fahrradbox",subGroup:"Typ",filter:["all",["any",["==",["get","type"],"LOCKERS"],["==",["get","type"],"LOCKBOX"]],["==",["get","purpose"],"BIKE"]],color:"#ff9933",visibility:"none",scope:["bicycle"],...e},{id:"parkApiItemType_LockersLockbox",label:"Schließfach",subGroup:"Typ",filter:["all",["any",["==",["get","type"],"LOCKERS"],["==",["get","type"],"LOCKBOX"]],["==",["get","purpose"],"ITEM"]],color:"#ff9933",visibility:"none",scope:["item"],...e},{id:"parkApiBicycleType_Shed",label:"Fahrrad-Sammelanlage",subGroup:"Typ",filter:["==",["get","type"],"SHED"],color:"#ee5959",visibility:"none",scope:["bicycle"],...e},{id:"parkApiBicycleType_TwoTier",label:"Offene Zweistock-Abstellanlage",subGroup:"Typ",filter:["==",["get","type"],"TWO_TIER"],color:"#009688",visibility:"none",scope:["bicycle"],...e},{id:"parkApiBicycleType_SafeWallLoops",label:"Vorderradhalter mit Sicherung",subGroup:"Typ",filter:["==",["get","type"],"SAFE_WALL_LOOPS"],color:"#30D5C8",visibility:"none",scope:["bicycle"],...e},{id:"parkApiBicycleType_Building",label:"Parkhaus",subGroup:"Typ",filter:["==",["get","type"],"BUILDING"],color:"#c2e72a",visibility:"none",scope:["bicycle"],...e},{id:"parkApiBicycleType_Floor",label:"Abstellfläche",subGroup:"Typ",filter:["==",["get","type"],"FLOOR"],color:"black",visibility:"none",scope:["bicycle"],...e}]}const K=q({id:E,layerGroup:st,layerFilter:it});if(R=="polygon"){const e={subGroup:"Typ",scope:["car","polygon"],source:"sourceParkApiCar",sourceLayer:"park-api_car",type:"circle",circleRadius:["interpolate",["linear"],["zoom"],6,5,9,4,12,3]};[{id:`parkApi${E}Type_Other_Circle`,label:"Sonstige",filter:["all",["any",["==",["get","type"],"OTHER"],["!",["has","type"]]],["<",["zoom"],13],["==",["get","geojson"],"POLYGON"]],color:"#cacaca",...e},{id:`parkApi${E}Type_OnStreet_Circle`,label:"Straßen-Parkplatz",filter:["all",["==",["get","type"],"ON_STREET"],["<",["zoom"],13],["==",["get","geojson"],"POLYGON"]],color:"black",...e},{id:`parkApi${E}Type_OffStreet_Circle`,label:"Parkplatz abseits der Straße",filter:["all",["==",["get","type"],"OFF_STREET_PARKING_GROUND"],["<",["zoom"],13],["==",["get","geojson"],"POLYGON"]],color:"#009688",...e},{id:`parkApi${E}Type_CarPark_Circle`,label:"Parkhaus",filter:["all",["==",["get","type"],"CAR_PARK"],["<",["zoom"],13],["==",["get","geojson"],"POLYGON"]],color:"#5587eb",...e}].forEach(r=>{K.push(r)})}let U;U=K.filter(t=>t.scope.includes(h));h=="car"&&(D==null&&I==null&&R==null&&z==null?U=K.filter(t=>t.scope.includes(h)):U=K.filter(t=>t.scope.includes(h)&&(t.scope.includes(D)||t.scope.includes(I)||t.scope.includes(R)||t.scope.includes(z))));const ht=q(T({purpose:"bicycle"})).filter(t=>t.scope.includes("bicycle"));function lt(){return fetch(`https://${Z}.mobidata-bw.de/park-api/api/public/v3/sources`).then(t=>t.json()).then(t=>t.items)}function ct(t){const e=t.capacity,a=t.realtime_capacity,r=t.realtime_free_capacity;if(r&&e&&(e!=0||a!=0)){const f=document.getElementById("anchor-"+t.id);if(f){const G='<td rowspan="7"><canvas class="canvasPie" id="canvas-'+t.id+'" width="110" height="96"></canvas></td>';f.outerHTML=G;const c=document.getElementById("canvas-"+t.id),s=c.getContext("2d"),o=a||e,i=r/o,P=(o-r)/o,v=(i*100).toFixed(0)+"%",d=(P*100).toFixed(0)+"%",k=(i*100).toFixed(0)+"%";let L=i*2,y=(1-i)*2;const C=["#5ce75c","#8B0000"],B=[v,d],S=[Math.PI*L,Math.PI*y],A=1;let p=-Math.PI/2,_=p;const b=c.width/2-10,g=c.height/2+7,n=40;for(let l=0;l<S.length;l++){p=_,_=_+S[l];const u=(p+_)/2,$=Math.cos(u)*A,m=Math.sin(u)*A;s.beginPath(),s.fillStyle=C[l%C.length],s.moveTo(b+$,g+m),s.arc(b+$,g+m,n,p,_),s.lineTo(b+$,g+m),s.fill(),y!==2&&y!==0&&(s.strokeStyle="white",s.lineWidth=.5,s.stroke());let O=b+Math.cos(u)*(n-18),N=g+Math.sin(u)*(n-18);s.fillStyle="white",s.font="bold 11px Arial",s.textAlign="center",o===r||r===0?s.fillText(k,b,g):((i<.15&&l===0||P<.15&&l===1)&&(s.fillStyle="black",O=b+Math.cos(u)*(n+5),N=g+Math.sin(u)*(n+5)),s.fillText(B[l],O,N))}}}}const nt=lt();function ft(t){const{parking_object:e,realtime_data_updated_at:a,realtime_data_outdated:r,has_realtime_data:f,source_id:G,id:c,name:s,operator_name:o,type:i,purpose:P,address:v,park_and_ride_type:d,realtime_opening_status:k,capacity:L,capacity_disabled:y,capacity_woman:C,capacity_family:B,capacity_charging:S,capacity_carsharing:A,realtime_capacity:p,realtime_free_capacity:_,public_url:b,photo_url:g,realtime_status:n,restriction_type:l,restriction_hours:u,restriction_max_stay:$}=t;let m,O;a&&({date:m,time:O}=et(a));const N=`
            <tr>
    ...
    `,J=`
            ...
            `}
            ${!B||B=="0"?"":`
            <tr><td class="att2">für Familien</td><td class="attContent2">${B}</td></tr>
            `}
            ${!S||S=="0"?"":`
        ...
        <table>
            ...
            <tr>
                ...
                ${r?`<td class="attContent outDated">${m}, ${O}</td>`:`<td class="attContent">${m}, ${O}</td>`}
            </tr>
            `}
        </table>
        <br>
