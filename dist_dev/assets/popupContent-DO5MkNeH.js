import{s as o}from"./addControlLayers-PtuRffpj.js";import{p as g}from"./popupImages-D0t3k1hi.js";const _=o({format:"mbtiles",file:"footway"}),k=o({format:"mbtiles",file:"marked"}),y=o({format:"mbtiles",file:"uncontrolled"}),F=o({format:"mbtiles",file:"zebra"}),n={group:"Fußgängerüberwege"},z=[{id:"uncontrolled",label:"Uncontrolled",source:"sourceUncontrolled",sourceLayer:"uncontrolled",color:"#C4001F",...n},{id:"footway",label:"Footway",source:"sourceFootway",sourceLayer:"footway",color:"#75b9a2",...n},{id:"marked",label:"Marked",source:"sourceMarked",sourceLayer:"marked",color:"#ffe280",...n},{id:"zebra",label:"Zebra",source:"sourceZebra",sourceLayer:"zebra",color:"#366491",...n}];function S(p){const{id:u,id_2:h,check_date:r,check_da_1:d,check_da_2:l,check_da_3:c,check_da_4:i,check_da_5:$,survey_dat:b,highway:e,turning_circle:C,kerb:a,surface:t,wheelchair:s,image:f}=p;return`
        <table>
            <tr>
                ${g("OpenStreetMap")}
