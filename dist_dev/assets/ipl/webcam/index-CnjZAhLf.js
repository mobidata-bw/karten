import{s as c,j as l,a as d,l as i,i as b,b as m,c as u,d as p}from"../../addControlLayers-v_hgsd_i.js";window.PUBLIC_PATH="/karten_dev/";const h=c({format:"geojson",directory:"maps/ipl/webcam",file:"webcam"}),C=[{id:"webcam",group:"Webcam-Bilder",label:"Standorte",source:"sourceWebcam",color:"grey"}];function g(t){const{strasse:e,bezeichnung:a,blickrichtung:r,kamera_nr:o,bild:n}=t;return`
        <table>
            <tr>              
                <th class='title'>${o}</th>
            </tr>
