import{s as m,a as g,l as C,i as k,b as z,c as L,d as $}from"../../addControlLayers-0lIGzMVq.js";import{p as P}from"../../popupImages-0K_rmlav.js";import{s as y}from"../../setupLayerInteractions-CT5YNCWO.js";window.PUBLIC_PATH="/karten_dev/";const j=m({format:"mbtiles",file:"transparenzportale"}),r={source:"sourceTransparenzportale",sourceLayer:"transparenzportale",group:"Transparenzportale",type:"fill"},v=[{id:"transparenzportale_Land",label:"Nationale Portale",filter:["==",["get","region"],"Land"],color:"#7dc4204d",...r},{id:"transparenzportale_Bundesland",label:"MobiData BW®",filter:["==",["get","region"],"Bundesland"],color:"#0c79bc",...r},{id:"transparenzportale_Verkehrsverbund",label:"Verbundsportale",filter:["==",["get","region"],"Verkehrsverbund"],color:"#d7a4a4",...r},{id:"transparenzportale_Kommune",label:"Kommunale Portale",filter:["==",["get","region"],"Kommune"],color:"#ffc300",...r}];function B(t){const{name:e,portal:a,ÖPNV:o,Sharing:s,Parken:l,Radverkehr:d,Laden:i,Barrierefreiheit:c,Baustellen:p,Verkehrszeichen:u,Verkehrskameras:b,Autoverkehr:h,url:f}=t;return`
        <table>
            <tr>
    ...
    `}function V(t){const e={collapsed:!1,layers:g(n,"Legende")},a=new C(e);t.addControl(a,"top-right")}let n;window.addEventListener("DOMContentLoaded",()=>{const t=k();z(t),t.on("load",()=>{[{id:"sourceTransparenzportale",source:j}].forEach(a=>L(t,a)),n=v,n.forEach(a=>$(t,a)),V(t),y(t,n,B)})});
