import{a as m,l as f,i as k,b as C,c as z,d as $}from"../../addControlLayers-DNDAzvbK.js";import{p as j}from"../../popupImages-Ddyl0QRV.js";import{p as L}from"../../popups-DZu3ZiZa.js";window.PUBLIC_PATH="/karten_dev/";const P={type:"geojson",data:"/karten_geojsons/maps/auswertungen/transparenzportale/transparenzportale.geojson"},r={source:"sourceTransparenzportale",group:"Transparenzportale",type:"fill"},v=[{id:"transparenzportale_Land",label:"Nationale Portale",filter:["==",["get","region"],"Land"],color:"#7dc4204d",...r},{id:"transparenzportale_Bundesland",label:"MobiData BW®",filter:["==",["get","region"],"Bundesland"],color:"#0c79bc",...r},{id:"transparenzportale_Verkehrsverbund",label:"Verbundsportale",filter:["==",["get","region"],"Verkehrsverbund"],color:"#d7a4a4",...r},{id:"transparenzportale_Kommune",label:"Kommunale Portale",filter:["==",["get","region"],"Kommune"],color:"#ffc300",...r}];function y(t){const{name:e,portal:a,ÖPNV:o,Sharing:s,Parken:l,Radverkehr:d,Laden:i,Barrierefreiheit:c,Baustellen:p,Verkehrszeichen:u,Verkehrskameras:b,Autoverkehr:h,url:g}=t;return`
        <table>
            <tr>
    ...
    `}function B(t){const e={collapsed:!1,layers:m(n,"Legende")},a=new f(e);t.addControl(a,"top-right")}let n;window.addEventListener("DOMContentLoaded",()=>{const t=k();C(t),t.on("load",()=>{[{id:"sourceTransparenzportale",source:P}].forEach(a=>z(t,a)),n=v,n.forEach(a=>$(t,a)),B(t),L(t,n,y)})});
